...
public class GemCustomListAdapter extends ArrayAdapter {
    ...
    public GemCustomListAdapter(Activity context, ArrayList<Gem> gemArrayList) {
        ...
        super(context, R.layout.gem_row, gemArrayList);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.gem_row, null, true);

        ImageView gemImageView = rowView.findViewById(R.id.gemImage);
        TextView gemTextView = rowView.findViewById(R.id.gemInfo);
        LinearLayout gemWrapperLL = rowView.findViewById(R.id.gemWrapperLL);
        TextView gemLink = rowView.findViewById(R.id.gemBorder);
        ...
        // First entry or first new item give spacing to the top
        ...
        if (position + 1 < gemArrayList.size()) {
            ...
            if (((gem.getGroupNum() == nextGem.getGroupNum())) && (gem.getEquipmentType() == nextGem.getEquipmentType())) {
                gemImageView.setBackgroundColor(ContextCompat.getColor(context, R.color.deadRed));
            }
        }
        ...
        gemTextView.setText(gem.getTypeLine() + " " + gemLevel + "/" + gem.getQuality());
